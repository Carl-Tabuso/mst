...
<template>
  ...
  >
    ...
    >
      ...
      <h2
        class="mb-4 text-lg font-semibold text-gray-900 dark:text-gray-100 sm:text-xl"
      >
        Confirm Ratings
      </h2>
      ...
      <div
        class="mb-4 max-h-64 overflow-auto rounded border border-gray-200 dark:border-gray-700"
      >
        <table class="w-full text-sm sm:text-base">
          <thead class="sticky top-0 bg-gray-100 dark:bg-gray-700">
            <tr>
              <th class="px-3 py-2 text-left text-gray-900 dark:text-gray-100">
                Employee
              </th>
              <th class="px-3 py-2 text-left text-gray-900 dark:text-gray-100">
                Position
