  ...
  <div
    ...
    <div class="flex items-center justify-between">
      ...
      <div class="flex flex-col items-start gap-1">
        <div class="flex items-center gap-3">
          <div class="flex gap-1">
            <span v-for="n in 5" :key="n" class="text-xl"
              :class="n <= rating ? 'text-lime-500 dark:text-lime-400' : 'text-gray-300 dark:text-gray-600'">
              ★
            </span>
          </div>
        ...
        <div v-if="description" class="px-1 text-sm text-gray-700 dark:text-gray-200">
          {{ description }}
        </div>
        <div v-else class="px-1 text-sm italic text-gray-400 dark:text-gray-500">
