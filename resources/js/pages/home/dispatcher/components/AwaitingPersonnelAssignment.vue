...
import { CalendarClock, UserRoundPen } from 'lucide-vue-next'
    ...
    <CardContent class="my-2 h-[375px] divide-y divide-border overflow-y-auto">
      ...
      >
        <div class="rounded-full bg-muted p-5 text-muted-foreground">
          <UserRoundPen class="size-20 stroke-1" />
        </div>
        <span class="flex flex-col items-center gap-1">
          <h4 class="text-xl font-bold">Team Ready!</h4>
          <p class="text-center text-[13px] leading-5">
            No job orders are waiting for personnel assignment.
          </p>
        </span>
      </div>
    </CardContent>
