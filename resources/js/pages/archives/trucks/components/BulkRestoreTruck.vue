...
interface BulkRestoreTruckProps {
  table: Table<Truck>
}

const props = defineProps<BulkRestoreTruckProps>()
...
const onBulkRestore = () => {
  router.patch(
    route('archive.truck.bulk_restore'),
    {
  ...
  <Dialog>
    ...
    <DialogContent class="w-fit">
      <VisuallyHidden as-child>
        <DialogTitle>Restoring Trucks</DialogTitle>
        <DialogDescription>
          <!---->
        </DialogDescription>
      </VisuallyHidden>
      <div class="flex flex-col items-center justify-center gap-2">
        ...
        <div class="text-3xl font-bold">
          Restoring {{ selectedRowModels.length }} Truck(s)
        </div>
