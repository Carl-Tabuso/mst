...
<template>
  <div class="space-y-6">
    ...
    <!-- Machines -->
    <div
      v-for="(machine, index) in form.machine_infos"
      :key="index"
      class="w-full space-y-4 rounded-2xl border bg-gray-50 p-6 shadow-inner"
    >
      ...
      <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
        ...
        <div class="md:col-span-2">
          ...
          <textarea
            v-model="machine.machine_problem"
            :disabled="!machineFieldsEnabled"
            class="input-field w-full"
          />
        </div>
        <div class="md:col-span-2">
          ...
          <textarea
            v-model="machine.service_performed"
            :disabled="!machineFieldsEnabled"
            class="input-field w-full"
          />
        </div>
        <div class="md:col-span-2">
          ...
          <textarea
            v-model="machine.recommendation"
            :disabled="!machineFieldsEnabled"
            class="input-field w-full"
          />
        </div>
        <div>
          ...
          <select
            v-model="machine.machine_status"
            :disabled="!machineFieldsEnabled"
            class="input-field w-full"
          >
            <option
      ...
      <div
        v-if="form.machine_infos.length > 1"
        class="mt-2 text-right"
      >
        <button
          type="button"
          @click="form.machine_infos.splice(index, 1)"
...
<style scoped>
.input-field {
  @apply rounded-xl border bg-white px-4 py-2 transition focus:outline-none focus:ring-2 focus:ring-blue-500;
}
</style>
