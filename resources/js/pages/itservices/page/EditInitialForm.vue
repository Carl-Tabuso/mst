    ...
    <AppLayout title="Edit Initial IT Service">
        <div class="px-4 md:px-12 xl:px-20 py-8">
            <div class="flex items-center justify-between mb-8">
                <div>
                    <h1 class="text-2xl font-semibold text-gray-700">Edit Initial IT Service</h1>
                    <p class="text-sm text-gray-500 mt-1">Update the service request details</p>
                </div>
                <div v-if="jobOrderNumber" class="text-lg font-semibold text-blue-900">
