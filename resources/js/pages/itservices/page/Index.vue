...
import { columns } from '../types/columns' // Reuse columns or create your own for IT services
      ...
      <div class="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
        <div class="mb-3 flex items-center">
          <div class="flex flex-col gap-y-1">
            <h3 class="scroll-m-20 text-3xl font-bold">IT Service List</h3>
            <p class="text-muted-foreground">
              You can manage the list of recent IT service job orders here!
            </p>
          </div>
          <div class="ml-auto">
            <Link :href="route('it-services.create')">
        ...
        <JobOrderDataTable
          ...
          :data="data"
          :meta="meta"
          route-name="job_order.it_service"
        />
      </div>
    </div>
  </AppLayout>
