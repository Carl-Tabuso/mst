...
import { useFirstOnsiteForm } from '../helpers/useFirstOnsiteForm';
    ...
    <AppLayout>
        <div class="px-4 md:px-12 xl:px-20 py-8">
            <div class="flex items-center justify-between mb-8">
                <div>
                    <h1 class="text-2xl font-semibold text-gray-700">First Onsite Visit</h1>
            ...
            <form @submit.prevent="submitForm" class="space-y-6">
                <ITServiceFirstOnsiteFields ref="formComponent" :form="form" :machineStatuses="machineStatuses" />
