    ...
    <AppLayout title="Edit First Onsite IT Service">
        <div class="px-4 md:px-12 xl:px-20 py-8">
            <div class="flex items-center justify-between mb-8">
                <div>
                    <h1 class="text-2xl font-semibold text-gray-700">Edit First Onsite Visit</h1>
                    <p class="text-sm text-gray-500 mt-1">Update the first onsite service report</p>
                </div>
            ...
            <form @submit.prevent="submitForm" class="space-y-6">
                ...
                <div v-if="props.existingReport.attached_file" class="bg-blue-50 p-4 rounded-xl">
                    <h3 class="text-sm font-medium text-blue-800 mb-2">Current Attached File</h3>
