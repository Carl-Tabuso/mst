...
const submitForm = () => {
  ...
  let isValidFirstOnsite =
    firstOnsiteFormComponent.value?.validateForm() ?? true
  let isValidFinalOnsite =
    finalOnsiteFormComponent.value?.validateForm() ?? true
  ...
  <AppLayout title="Edit Final Onsite IT Service">
    <div class="px-4 py-8 md:px-12 xl:px-20">
      <div class="mb-8 flex items-center justify-between">
        <div>
          <h1 class="text-2xl font-semibold text-gray-700">
            Edit Final Onsite Visit
          </h1>
          <p class="mt-1 text-sm text-gray-500">
            Update the complete service report
          </p>
        </div>
      ...
      >
        ...
        <!-- First Onsite Fields -->
        <div class="px-6">
          <ITServiceFirstOnsiteFieldsForEdit
...
<style scoped>
.input-field {
  @apply rounded-lg border border-gray-300 bg-white px-3 py-2 transition-colors focus:border-blue-200 focus:outline-none focus:ring-1 focus:ring-blue-200;
}
</style>
