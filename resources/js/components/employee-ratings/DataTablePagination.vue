...
<template>
  <div
    class="flex flex-col items-center justify-between gap-4 p-3 sm:flex-row sm:gap-8"
  >
    <div class="flex items-center gap-2">
      ...
      >
        <SelectTrigger
          class="h-8 w-[70px] dark:border-gray-700 dark:bg-zinc-900 dark:text-gray-200"
        >
          <SelectValue
        ...
        <SelectContent
          side="top"
          class="dark:border-gray-700 dark:bg-zinc-900 dark:text-gray-200"
        >
          <SelectItem
