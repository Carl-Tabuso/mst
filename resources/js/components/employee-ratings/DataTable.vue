...
const pagination = ref<PaginationState>({
    pageIndex: props.meta?.current_page ? props.meta.current_page - 1 : 0,
...
<template>
    <DataTableToolbar :table="table" :globalFilter="globalFilter" :routeName="props.routeName" />
    ...
    <DataTablePagination v-if="props.meta" :table="table" :lastPage="props.meta.last_page" />
</template>
