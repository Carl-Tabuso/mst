            ...
            <div class="flex flex-col space-y-5 mb-5">
                ...
                <div class="grid grid-cols-3 gap-y-6 gap-x-10">
                    <div v-for="status in JobOrderStatuses" :key="status.id" class="flex items-center gap-x-2">
                        <Checkbox :id="status.id" :checked="selectedStatuses.has(status.id)"
                ...
                <div class="grid grid-cols-2 gap-10">
                    ...
                    <div class="flex items-center">
                        ...
                        <Popover>
                            ...
                            <PopoverContent class="w-auto p-0">
                                <AppCalendar :model-value="props.value?.fromDateOfService"
                    ...
                    <div class="flex items-center">
                        ...
                        <Popover>
                            ...
                            <PopoverContent class="w-auto p-0">
                                <AppCalendar :model-value="props.value?.toDateOfService"
