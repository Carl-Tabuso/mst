...
export const columns: ColumnDef<Task>[] = [
  ...
  },
  {
    ...
    header: ({ column }) =>
      h(DataTableColumnHeader, { column, title: 'Frontliner' }),
  ...
  },
  {
    accessorKey: 'type',
    header: ({ column }) =>
      h(DataTableColumnHeader, { column, title: 'Type of Service' }),
  ...
  },
  {
    accessorKey: 'date',
    header: ({ column }) =>
      h(DataTableColumnHeader, { column, title: 'Date & Time Requested' }),
  ...
  },
  {
    accessorKey: 'reason',
    header: ({ column }) =>
      h(DataTableColumnHeader, { column, title: 'Reason' }),
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return h('div', { class: classes }, [h('span', status.label)])
    },
